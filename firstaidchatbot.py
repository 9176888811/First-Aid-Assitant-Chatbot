...
GROQ_API_KEY = "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"  # Replace with your actual API key
...
with gr.Blocks(title="First Aid Assistant", theme=gr.themes.Soft()) as demo:
    gr.Markdown(
        ...
        **⚠️ Disclaimer:** This is for informational purposes only. Always seek professional medical help in emergencies.
        """
    )
...
if __name__ == "__main__":
    print("🏥 Starting First Aid Assistant...")
    print("⚠️  Remember to replace 'your_groq_api_key_here' with your actual Groq API key!")
